...
namespace PROYECTO2_PROMOCIONES_EMANOSALVAS.Comunes
{
    public class ConexionBD
    {
        ...
        public static SqlConnection abrirConexion()
        {
            ...
            conexion = new SqlConnection("Server=LT-EMANOSALVAS\\SQLEXPRESS;Database=PROYECTO_2;User Id=sa;Password=Representaciones.2024;");
            conexion.Open();
            return conexion;
        }
